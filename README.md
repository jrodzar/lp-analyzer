...
- **Posiciones cerradas** — las posiciones de las que ya retiraste la liquidez (pero conservas el NFT/cuenta) **siempre cuentan** en los totales del resumen, el PnL y el gráfico Histórico (sus fees cobradas no se pierden). Para no estorbar la lista, se agrupan en una sección **🗃️ Posiciones cerradas** colapsada por defecto, debajo de los "Tokens idle" de cada cartera (en **Quick** y **Portfolio**).
- **Cuatro vistas**:
